...
public class ComposVisitor<A> implements
    ...
    /* Program */
    public Program visit(latte.Absyn.ProgramCode p, A arg) {
    ...
    /* Arg */
    public Arg visit(latte.Absyn.ArgCode p, A arg) {
        Type type_ = p.type_.accept(this, arg);
        String ident_ = p.ident_;
    ...
    /* Block */
    public Block visit(latte.Absyn.BlockCode p, A arg)  {
    ...
    public Stmt visit(latte.Absyn.CondElse p, A arg)  {
        ...
        Stmt stmt_2 = null;
        try {
            stmt_2 = p.stmt_2.accept(this, arg);
        } catch (Exception e) {
            e.printStackTrace();
        }
