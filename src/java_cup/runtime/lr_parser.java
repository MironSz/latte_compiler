 ...
 * </dl>
 * <p>
 * n addition to these routines that <i>must</i> be supplied by the
 * enerated subclass there are also a series of routines that <i>may</i>
 * e supplied.  These include:
 * <dl>
 * <dt> Symbol scan()
