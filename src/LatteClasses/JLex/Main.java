/**************************************************************
 LatteClasses.JLex: A Lexical Analyzer Generator for Java(TM)
 ...
 Fixed a bug which certain forms of comment in the LatteClasses.JLex directives section
 ...
 Fixed a bug that would cause LatteClasses.JLex not to terminate given certain input
 ...
 LatteClasses.JLex to generate a parser conforming to the java_cup.runtime.Scanner
 ...
 JLS (15.27) to convince me that the LatteClasses.JLex construction actually was
 illegal.  Reported against 1.2.5b6, but this bit of code has been
 present since the very first version of LatteClasses.JLex (1.1.1).
 ...
 Notes:
 Simply changed the name from JavaLex to LatteClasses.JLex.  No other changes.
...
class CSpec {
    ...
    /* LatteClasses.JLex directives flags. */
    ...
    /* Lexical Generator. */
    private final CLexGen m_lexGen;
    ...
    (
        ...
        /* Initialize variables for LatteClasses.JLex runtime options. */
        m_verbose = true;
...
public class Main {
    ...
    (
        ...
        if (arg.length < 1) {
            System.out.println("Usage: LatteClasses.JLex.Main <filename>");
            return;
        }
...
class CInput {
    /***************************************************************
     Member Variables
     **************************************************************/
    private final java.io.BufferedReader m_input; /* LatteClasses.JLex specification file. */
...
class CError {
    ...
    (
        ...
        System.out.println("LatteClasses.JLex Error: " + message);
    }
    ...
    static final String[] errmsg =
            {
                    ...
                    "LatteClasses.JLex has not been successfully initialized.",
                    "Unexpected end-of-file found.",
                    "Undefined or badly-formed LatteClasses.JLex directive.",
                    "Internal LatteClasses.JLex error.",
...
class CLexGen {
    /***************************************************************
     Member Variables
     **************************************************************/
    private final java.io.Reader m_instream; /* LatteClasses.JLex specification file. */
    ...
    (
        ...
        if (m_spec.m_verbose) {
            System.out.println("Processing second section -- "
                    + "LatteClasses.JLex declarations.");
        }
        userDeclare();
        if (m_input.m_eof_reached) {
            CError.parse_error(CError.E_EOF, m_input.m_line_number);
    ...
    /***************************************************************
     Member Variables: LatteClasses.JLex directives.
     **************************************************************/
    private final char[] m_state_dir = {
            '%', 's', 't',
            'a', 't', 'e',
            '\0'
    };

    private final char[] m_char_dir = {
            '%', 'c', 'h',
            'a', 'r',
            '\0'
    };

    private final char[] m_line_dir = {
            '%', 'l', 'i',
            'n', 'e',
            '\0'
    };

    private final char[] m_cup_dir = {
            '%', 'c', 'u',
            'p',
            '\0'
    };

    private final char[] m_class_dir = {
            '%', 'c', 'l',
            'a', 's', 's',
            '\0'
    };

    private final char[] m_implements_dir = {
            '%', 'i', 'm', 'p', 'l', 'e', 'm', 'e', 'n', 't', 's',
            '\0'
    };

    private final char[] m_function_dir = {
            '%', 'f', 'u',
            'n', 'c', 't',
            'i', 'o', 'n',
            '\0'
    ...
    private final char[] m_type_dir = {
            '%', 't', 'y',
            'p', 'e',
            '\0'
    };

    private final char[] m_integer_dir = {
            '%', 'i', 'n',
            't', 'e', 'g',
            'e', 'r',
            '\0'
    ...
    private final char[] m_intwrap_dir = {
            '%', 'i', 'n',
            't', 'w', 'r',
            'a', 'p',
            '\0'
    ...
    private final char[] m_full_dir = {
            '%', 'f', 'u',
            'l', 'l',
            '\0'
    };

    private final char[] m_unicode_dir = {
            '%', 'u', 'n',
            'i', 'c', 'o',
            'd', 'e',
            '\0'
    ...
    private final char[] m_ignorecase_dir = {
            '%', 'i', 'g',
            'n', 'o', 'r',
            'e', 'c', 'a',
            's', 'e',
    ...
    private final char[] m_notunix_dir = {
            '%', 'n', 'o',
            't', 'u', 'n',
            'i', 'x',
            '\0'
    ...
    private final char[] m_init_code_end_dir = {
            '%', 'i', 'n',
            'i', 't', '}',
            '\0'
    };

    private final char[] m_init_throw_code_dir = {
            '%', 'i', 'n',
            'i', 't', 't',
            'h', 'r', 'o',
            'w', '{',
    ...
    private final char[] m_init_throw_code_end_dir = {
            '%', 'i', 'n',
            'i', 't', 't',
            'h', 'r', 'o',
            'w', '}',
    ...
    private final char[] m_yylex_throw_code_dir = {
            '%', 'y', 'y', 'l',
            'e', 'x', 't',
            'h', 'r', 'o',
            'w', '{',
    ...
    private final char[] m_yylex_throw_code_end_dir = {
            '%', 'y', 'y', 'l',
            'e', 'x', 't',
            'h', 'r', 'o',
            'w', '}',
    ...
    private final char[] m_eof_code_dir = {
            '%', 'e', 'o',
            'f', '{',
            '\0'
    };

    private final char[] m_eof_code_end_dir = {
            '%', 'e', 'o',
            'f', '}',
            '\0'
    };

    private final char[] m_eof_value_code_dir = {
            '%', 'e', 'o',
            'f', 'v', 'a',
            'l', '{',
            '\0'
    ...
    private final char[] m_eof_value_code_end_dir = {
            '%', 'e', 'o',
            'f', 'v', 'a',
            'l', '}',
            '\0'
    ...
    private final char[] m_eof_throw_code_dir = {
            '%', 'e', 'o',
            'f', 't', 'h',
            'r', 'o', 'w',
            '{',
    ...
    private final char[] m_eof_throw_code_end_dir = {
            '%', 'e', 'o',
            'f', 't', 'h',
            'r', 'o', 'w',
            '}',
    ...
    private final char[] m_class_code_dir = {
            '%', '{',
            '\0'
    };

    private final char[] m_class_code_end_dir = {
            '%', '}',
            '\0'
    };

    private final char[] m_yyeof_dir = {
            '%', 'y', 'y',
            'e', 'o', 'f',
            '\0'
    };

    private final char[] m_public_dir = {
            '%', 'p', 'u',
            'b', 'l', 'i',
            'c', '\0'
    };
    ...
    /***************************************************************
     Function: userRules
     Description: Processes third section of LatteClasses.JLex
